...
import synchmanager.database.interfaces.IDatabaseManagerSocket
...
class DatabaseManagerSocket: IDatabaseManagerSocket {
    private lateinit var clientSocket: Socket
    private lateinit var printWriter: PrintWriter
    private lateinit var bufferedReader: BufferedReader
    private val logger: Logger = LoggerFactory.getLogger(DatabaseManagerSocket::class.java)
    ...
    private fun openSockets() {
        ...
        clientSocket = Socket("127.0.0.1", PortProperties.getDatabasePort())
